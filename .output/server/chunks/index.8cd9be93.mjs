const imgSrc = (url) => url.length > 0 ? url : "/icons/avatar.svg";
...
const useUi = () => {
  return {
    ...
    tabbuttonselected: (selected) => {
      return selected ? "bg-white shadow" : "text-blue-100 hover:bg-white/[0.12] hover:text-white";
    },
...
const obj2Str = (obj) => Object.keys(obj).reduce((acc, cur) => acc + `${cur}:${obj[cur]};`, "");

export { imgSrc as i, obj2Str as o, useUi as u };
//# sourceMappingURL=index.8cd9be93.mjs.map
